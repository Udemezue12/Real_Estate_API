...
def upgrade() -> None:
    ...
    sa.Column('paystack_bank_code', sa.String(), nullable=True),
    sa.Column('flutterwave_bank_code', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', name='uq_bank_canonical')
    )
    op.create_index(op.f('ix_banks_canonical_name'), 'banks', ['canonical_name'], unique=False)
    ...
    sa.Column('status', sa.Enum('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', name='payoutstatus', native_enum=False), nullable=False),
    ...
    sa.Column('role', sa.Enum('TENANT', 'LANDLORD', 'LAWYER', 'CARETAKER', 'AGENT', 'SELLER', 'ADMIN', 'USER', name='userrole', native_enum=False), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('key', 'user_id', name='uq_idempotency_key')
    )
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('flutterwave_account_name', sa.String(length=255), nullable=True),
    sa.Column('paystack_account_name', sa.String(length=255), nullable=True),
    ...
    sa.Column('nin_hash', sa.String(length=64), nullable=True),
    sa.Column('account_number', sa.String(length=64), nullable=True),
    sa.Column('bank_name', sa.String(length=255), nullable=False),
    sa.Column('paystack_bank_code', sa.String(length=64), nullable=True),
    sa.Column('flutterwave_bank_code', sa.String(length=64), nullable=True),
    sa.Column('paystack_account_verified', sa.Boolean(), nullable=False),
    sa.Column('paystack_account_verification_error', sa.Text(), nullable=True),
    sa.Column('paystack_account_verified_at', sa.DateTime(), nullable=True),
    sa.Column('paystack_account_verification_status', sa.Enum('PENDING', 'VERIFIED', 'FAILED', name='accountnumberverificationstatus', native_enum=False), nullable=False),
    sa.Column('paystack_account_verification_provider', sa.Enum('PAYSTACK', 'FLUTTERWAVE', 'NONE_YET', name='accountverificationproviders', native_enum=False), nullable=False),
    sa.Column('flutterwave_account_verified', sa.Boolean(), nullable=False),
    sa.Column('flutterwave_account_verification_error', sa.Text(), nullable=True),
    sa.Column('flutterwave_account_verified_at', sa.DateTime(), nullable=True),
    sa.Column('flutterwave_account_verification_status', sa.Enum('PENDING', 'VERIFIED', 'FAILED', name='accountnumberverificationstatus', native_enum=False), nullable=False),
    sa.Column('flutterwave_account_verification_provider', sa.Enum('PAYSTACK', 'FLUTTERWAVE', 'NONE_YET', name='accountverificationproviders', native_enum=False), nullable=False),
    sa.Column('nin_verified', sa.Boolean(), nullable=False),
    sa.Column('bvn_verified', sa.Boolean(), nullable=False),
    sa.Column('nin_verified_at', sa.DateTime(), nullable=True),
    sa.Column('bvn_verified_at', sa.DateTime(), nullable=True),
    sa.Column('date_of_birth', sa.Date(), nullable=True),
    sa.Column('gender', sa.Enum('MALE', 'FEMALE', name='genderchoices', native_enum=False), nullable=False),
    sa.Column('address', sa.Text(), nullable=False),
    sa.Column('nin_verification_error', sa.Text(), nullable=True),
    sa.Column('state_of_birth', sa.String(length=60), nullable=False),
    sa.Column('occupation', sa.String(length=100), nullable=True),
    sa.Column('nin_verification_status', sa.Enum('PENDING', 'VERIFIED', 'FAILED', name='ninverificationstatus', native_enum=False), nullable=False),
    sa.Column('nin_verification_provider', sa.Enum('YOU_VERIFY', 'QORE_ID', 'PREMBLY', 'NONE_YET', name='ninverificationproviders', native_enum=False), nullable=False),
    sa.Column('bvn_status', sa.Enum('PENDING', 'VERIFIED', 'FAILED', name='bvnstatus', native_enum=False), nullable=False),
    sa.Column('bvn_verification_error', sa.Text(), nullable=True),
    sa.Column('bvn_verification_provider', sa.Enum('YOU_VERIFY', 'QORE_ID', 'PREMBLY', 'NONE_YET', name='bvnverificationproviders', native_enum=False), nullable=False),
    ...
    sa.Column('flutterwave_beneficiary_id', sa.String(length=100), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_index(op.f('ix_user_profiles_account_number'), 'user_profiles', ['account_number'], unique=False)
    op.create_index(op.f('ix_user_profiles_bank_name'), 'user_profiles', ['bank_name'], unique=False)
    op.create_index(op.f('ix_user_profiles_bvn_status'), 'user_profiles', ['bvn_status'], unique=False)
    op.create_index(op.f('ix_user_profiles_bvn_verified'), 'user_profiles', ['bvn_verified'], unique=False)
    op.create_index(op.f('ix_user_profiles_bvn_verified_at'), 'user_profiles', ['bvn_verified_at'], unique=False)
    ...
    op.create_index(op.f('ix_user_profiles_flutterwave_account_name'), 'user_profiles', ['flutterwave_account_name'], unique=False)
    op.create_index(op.f('ix_user_profiles_flutterwave_account_verification_status'), 'user_profiles', ['flutterwave_account_verification_status'], unique=False)
    op.create_index(op.f('ix_user_profiles_flutterwave_account_verified'), 'user_profiles', ['flutterwave_account_verified'], unique=False)
    op.create_index(op.f('ix_user_profiles_flutterwave_account_verified_at'), 'user_profiles', ['flutterwave_account_verified_at'], unique=False)
    op.create_index(op.f('ix_user_profiles_flutterwave_bank_code'), 'user_profiles', ['flutterwave_bank_code'], unique=False)
    op.create_index(op.f('ix_user_profiles_flutterwave_beneficiary_id'), 'user_profiles', ['flutterwave_beneficiary_id'], unique=False)
    op.create_index(op.f('ix_user_profiles_id'), 'user_profiles', ['id'], unique=False)
    op.create_index(op.f('ix_user_profiles_nin_hash'), 'user_profiles', ['nin_hash'], unique=False)
    op.create_index(op.f('ix_user_profiles_nin_verification_status'), 'user_profiles', ['nin_verification_status'], unique=False)
    op.create_index(op.f('ix_user_profiles_nin_verified'), 'user_profiles', ['nin_verified'], unique=False)
    op.create_index(op.f('ix_user_profiles_nin_verified_at'), 'user_profiles', ['nin_verified_at'], unique=False)
    op.create_index(op.f('ix_user_profiles_paystack_account_name'), 'user_profiles', ['paystack_account_name'], unique=False)
    op.create_index(op.f('ix_user_profiles_paystack_account_verification_status'), 'user_profiles', ['paystack_account_verification_status'], unique=False)
    op.create_index(op.f('ix_user_profiles_paystack_account_verified'), 'user_profiles', ['paystack_account_verified'], unique=False)
    op.create_index(op.f('ix_user_profiles_paystack_account_verified_at'), 'user_profiles', ['paystack_account_verified_at'], unique=False)
    op.create_index(op.f('ix_user_profiles_paystack_bank_code'), 'user_profiles', ['paystack_bank_code'], unique=False)
    op.create_index(op.f('ix_user_profiles_paystack_recipient_code'), 'user_profiles', ['paystack_recipient_code'], unique=False)
    ...
    sa.Column('landlord_profile_id', sa.UUID(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['landlord_profile_id'], ['user_profiles.id'], ),
    sa.ForeignKeyConstraint(['tenant_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_rent_invoices_provider_reference'), 'rent_invoices', ['provider_reference'], unique=True)
    ...
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('sold_by', sa.Enum('MYSELF', 'SOMEONE_ELSE', 'NOT_SOLD', name='sold_by', native_enum=False), nullable=False),
    sa.Column('contact_phone', sa.String(length=20), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('address', sa.String(length=255), nullable=False),
    sa.Column('parking_spaces', sa.Integer(), nullable=True),
    ...
    op.create_index(op.f('ix_sale_listings_sold_by'), 'sale_listings', ['sold_by'], unique=False)
    ...
    sa.Column('letter_type', sa.Enum('EVICTION_NOTICE', 'WARNING_LETTER', 'RENT_REMINDER', 'GENERAL_NOTICE', name='lettertype', native_enum=False), nullable=False),
    sa.Column('title', sa.String(length=255), nullable=False),
    ...
    op.create_index(op.f('ix_letters_letter_type'), 'letters', ['letter_type'], unique=False)
    op.create_index(op.f('ix_letters_property_id'), 'letters', ['property_id'], unique=False)
    op.create_index(op.f('ix_letters_sender_id'), 'letters', ['sender_id'], unique=False)
    ...
    sa.Column('matched_user_verified', sa.Boolean(), nullable=False),
    ...
    op.create_index(op.f('ix_tenants_matched_user_verified'), 'tenants', ['matched_user_verified'], unique=False)
    ...
    op.create_table('letter_recipients',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('letter_id', 'tenant_id', name='uq_letter_tenant')
    )
    op.create_index(op.f('ix_letter_recipients_is_read'), 'letter_recipients', ['is_read'], unique=False)
    op.create_index(op.f('ix_letter_recipients_letter_id'), 'letter_recipients', ['letter_id'], unique=False)
    op.create_index(op.f('ix_letter_recipients_property_id'), 'letter_recipients', ['property_id'], unique=False)
    op.create_index(op.f('ix_letter_recipients_tenant_id'), 'letter_recipients', ['tenant_id'], unique=False)
    ...
    sa.Column('landlord_phoneNumber', sa.String(length=20), nullable=True),
    sa.Column('tenant_phoneNumber', sa.String(length=20), nullable=True),
    sa.Column('landlord_email', sa.String(), nullable=False),
    sa.Column('tenant_firstname', sa.String(length=255), nullable=False),
    sa.Column('tenant_lastname', sa.String(length=255), nullable=False),
    sa.Column('tenant_middlename', sa.String(length=255), nullable=False),
    sa.Column('landlord_firstname', sa.String(length=255), nullable=False),
    sa.Column('landlord_lastname', sa.String(length=255), nullable=False),
    sa.Column('landlord_middlename', sa.String(length=255), nullable=False),
    sa.Column('property_owner_id', sa.UUID(), nullable=False),
    sa.Column('property_id', sa.UUID(), nullable=False),
    sa.Column('payment_provider', sa.Enum('PAYSTACK', 'FLUTTERWAVE', 'NONE_YET', name='paymentprovider', native_enum=False), nullable=False),
    sa.Column('provider_reference', sa.String(length=255), nullable=True),
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('tenant_id', sa.UUID(), nullable=False),
    sa.Column('payment_context', sa.Enum('FULL_RENT', 'HALF_RENT', 'OUTSTANDING_BALANCE', name='payment_context'), nullable=False),
    sa.Column('property_id', sa.UUID(), nullable=False),
    ...
    sa.UniqueConstraint('tenant_id', 'property_id', 'month_paid_for', 'year_paid_for', name='uq_rent_receipt_per_month')
    )
    op.create_index(op.f('ix_rent_receipts_fully_paid'), 'rent_receipts', ['fully_paid'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_rent_receipts_fully_paid'), table_name='rent_receipts')
    ...
    op.drop_index(op.f('ix_letter_recipients_tenant_id'), table_name='letter_recipients')
    op.drop_index(op.f('ix_letter_recipients_property_id'), table_name='letter_recipients')
    op.drop_index(op.f('ix_letter_recipients_letter_id'), table_name='letter_recipients')
    op.drop_index(op.f('ix_letter_recipients_is_read'), table_name='letter_recipients')
    op.drop_table('letter_recipients')
    ...
    op.drop_index(op.f('ix_tenants_matched_user_verified'), table_name='tenants')
    ...
    op.drop_index(op.f('ix_letters_sender_id'), table_name='letters')
    op.drop_index(op.f('ix_letters_property_id'), table_name='letters')
    op.drop_index(op.f('ix_letters_letter_type'), table_name='letters')
    op.drop_index(op.f('ix_letters_created_at'), table_name='letters')
    op.drop_table('letters')
    op.drop_index(op.f('ix_sale_listings_sold_by'), table_name='sale_listings')
    ...
    op.drop_index(op.f('ix_rent_invoices_provider_reference'), table_name='rent_invoices')
    ...
    op.drop_index(op.f('ix_user_profiles_paystack_recipient_code'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_paystack_bank_code'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_paystack_account_verified_at'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_paystack_account_verified'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_paystack_account_verification_status'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_paystack_account_name'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_nin_verified_at'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_nin_verified'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_nin_verification_status'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_nin_hash'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_id'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_flutterwave_beneficiary_id'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_flutterwave_bank_code'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_flutterwave_account_verified_at'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_flutterwave_account_verified'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_flutterwave_account_verification_status'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_flutterwave_account_name'), table_name='user_profiles')
    ...
    op.drop_index(op.f('ix_user_profiles_bvn_verified_at'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_bvn_verified'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_bvn_status'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_bank_name'), table_name='user_profiles')
    op.drop_index(op.f('ix_user_profiles_account_number'), table_name='user_profiles')
    ...
    op.drop_index(op.f('ix_banks_canonical_name'), table_name='banks')
    op.drop_table('banks')
    # ### end Alembic commands ###
