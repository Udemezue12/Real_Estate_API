...
@cbv(router)
class SalesMessageRoutes:
    @router.patch(
        "/conversations/{convo_id}/viewing/schedule",
        response_model=SaleConversationOut,
    ...
    async def schedule_viewing(
        ...
        return await SalesMessagingService(db).schedule_viewing(
            convo_id=convo_id,
    ...
    async def delete_viewing(
        ...
        return await SalesMessagingService(db).cancel_viewing(
            convo_id=convo_id,
            current_user=current_user,
        )
    ...
    async def approve_viewing(
        ...
        return await SalesMessagingService(db).approve_viewing(convo_id=convo_id)
    ...
    async def decline_viewing(
        ...
        return await SalesMessagingService(db).decline_viewing(
            convo_id=convo_id,
        )
    ...
    async def start_conversation(
        ...
        return await SalesMessagingService(db).start_or_get_conversation(
    ...
    async def send_message(
        ...
        return await SalesMessagingService(db).send_message(
    ...
    async def list_messages(
        ...
        return await SalesMessagingService(db).list_messages(
            current_user=current_user,
    ...
    async def list_cursor_messages(
        ...
        return await SalesMessagingService(db).list_messages_for_cursor(
            current_user=current_user,
            conversation_id=conversation_id,
            limit=limit,
            before=before,
    ...
    async def hard_delete_message(
        ...
        return await SalesMessagingService(db).hard_delete_message(
            current_user=current_user,
            conversation_id=conversation_id,
        )
    ...
    async def soft_delete_message(
        ...
        return await SalesMessagingService(db).soft_delete_message(
